 ...
 * @author Karelin
 */
public class NewArrivalWarehauseUI extends javax.swing.JFrame {
    private JComboBox goodsBox;
    private TableColumn goodsColumn;

    /**
     * Creates new form NewArrivalWarehauseUI
     */
    public NewArrivalWarehauseUI() {
        initComponents();
        ...
        for (Goods war : MainUI.getGoodslist()) 
            {goodsBox.addItem(war.getName());}
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Наименование товара", "Склад", "Количество", "Поставщик", "№ документа"
            }
        ) {
        ...
        jButton3.setText("Принять товар");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i =0; i < jTable1.getModel().getRowCount(); i++)
        {
            try
            {
                ...
                {
                    ArrivalWarehouse arr = new ArrivalWarehouse();
                    ...
                    for (Warehouses war : MainUI.getWarlist()) 
                    {
                        ...
                        {arr.setActivePointId(war); System.err.println(war.getId());}
                    }
