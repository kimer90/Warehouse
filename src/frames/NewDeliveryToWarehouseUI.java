 ...
 * @author Karelin
 */
public class NewDeliveryToWarehouseUI extends javax.swing.JFrame {

    /**
     * Creates new form NewDeliveryToWarehouseUI
     */
    public NewDeliveryToWarehouseUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Наименование товара", "Склад", "Количество", "Откуда", "№ документа"
            }
        ) {
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (Facility facil : MainUI.getFacillist())
                    {
                        ...
                        {arr.setPassivePointId(facil); System.err.println(facil.getId());}
                    }
